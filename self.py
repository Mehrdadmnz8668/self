...
api_id = 9848517 # <- API-ID
api_hash = '5b769738fb6a146cb6345cbb9e8ebbc2' # <- API-HASH

app = Client("ISOVPN",api_id,api_hash)


with app:
  try:
    app.join_chat("@ISO_VPN")
  except:
    pass
